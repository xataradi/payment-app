...
public class PaymentCompletionTimerAdv {
    public static void main(String[] args) throws Exception {
        ...
        payments.print();
        payments.writeAsText("E://Log/PaymentCompleteTimeAdvInput.txt",org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
        ...
        finalInterval.print();
        finalInterval.writeAsText("E://Log/PaymentCompleteTimeAdvOutput.txt",org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);

        newStream.writeAsText("E://Log/PaymentCompleteTimeAlertAdvOutput.txt",org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
