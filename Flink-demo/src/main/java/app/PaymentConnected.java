...
public class PaymentConnected {
    ...
    public static void main(String[] args) throws Exception {
        ...
        payments.writeAsText("E://Log/PaymentConnectedInput.txt");
        ...
        enrichedStreams.writeAsText("E://Log/PaymentConnectedOutput.txt",org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE);
