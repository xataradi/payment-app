// xử lý dữ liệu thanh toán sau đó lưu vào 1 log có sẵn
...
public class PaymentByFlatMap {
    public static void main(String[] args) throws Exception {
            ...
            payments.writeAsText("E://Log/PaymentByFlatMapInput.txt");
           ...
           paymentFiltered.print();
            DataStream<Tuple2<String, Integer>> counts = paymentFiltered
                    ...
                    .sum(1);
            counts.print();
            counts.writeAsText("E://Log/PaymentByFlatMapOutput.txt");
            env.execute();
    }
}
