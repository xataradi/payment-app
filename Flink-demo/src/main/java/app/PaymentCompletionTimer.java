...
public class PaymentCompletionTimer {
    public static void main(String[] args) throws Exception {
        ...
        payments.print();
        payments.writeAsText("E://Log/PaymentCompleteTimeInput.txt",org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
        ...
        newStream.writeAsText("E://Log/PaymentCompleteTimeAlertOutput.txt",org.apache.flink.core.fs.FileSystem.WriteMode.OVERWRITE).setParallelism(1);
        env.execute();
        }
    }
